      ...
      <div className="isolate flex flex-col h-screen">
        <div onClick={() => setMobileMenuOpen(true)}>
          <span
            ...
            <i className="bx bx-menu bx-sm px-3 p-3 bg-blue hover:bg-indigo-600 rounded-md bg-blue opacity-50 hover:bg-green-50"></i>
          </span>
        </div>
        <div className="hidden lg:flex flex-col w-64 bg-white flex-shrink-0 h-screen">
          <a target="_blank" rel="noopener noreferrer">
            <img src={logo} alt="LogoIcon" className="py-6 ml-4 w-52" />
          </a>
                    ...
                    <Transition.Child
                      ...
                      <div className="flex flex-col h-screen">
                        <div className="flex flex-row h-12 w-full">
                          <a href="https://digitalfarming.eu/" target="_blank" rel="noopener noreferrer">
